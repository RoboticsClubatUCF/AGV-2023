...
if ! grep -q "GAZEBO_MODEL_PATH=" $bashrc; then
	...
	echo "export GAZEBO_MODEL_PATH=\$GAZEBO_MODEL_PATH:/home/\$USER/catkin_ws/src/AGV-2023/agv_sim/models" >> $bashrc
fi

if ! grep -q "GAZEBO_RESOURCE_PATH=" $bashrc; then
	echo "GAZEBO_RESOURCE PATH not found, setting GAZEBO_RESOURCE_PATH"
	echo "export GAZEBO_RESOURCE_PATH=\$GAZEBO_RESOURCE_PATH:/home/\$USER/catkin_ws/src/AGV-2023/agv_sim/meshes" >> $bashrc
fi
